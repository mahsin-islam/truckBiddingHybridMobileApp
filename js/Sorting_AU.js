...
//            $('#topcontainerTruckdetails').append('<div class="clearheight"></div>')
            ...
            var catgrytoPalce = in_t[i]._source.cat_1_name;
            catgrytoPalce = catgrytoPalce.trim();
            catgrytoPalce = catgrytoPalce+'/'+(in_t[i]._source.cat_2_name).trim();
            if( in_t[i]._source.hasOwnProperty('cat_3_name'))
            {
                if( in_t[i]._source.cat_3_name != '' || in_t[i]._source.cat_3_name != null)
                {
                    catgrytoPalce = catgrytoPalce+'/'+(in_t[i]._source.cat_3_name).trim();
                }
            }
            ...
            {
                $('#container_ressearcgPage').append('<div class="sliderbg" id="topcontainerTruckdetails"><div class="slider-main" id="truckdetailsandPic_Au"><div class="slider-top"><div class="sliderimages"><img src="'+imgurl+'" onclick="getTruckDetails_AU(\''+truckId_Selctd+'\')"></div></div><div class="slidercontner" id="Truckdetails_Container_AU"><div class="top" id="headrTruckDetails_AU"><h3>'+in_t[i]._source.headline+'</h3>'+catgrytoPalce+'</div><div class="mid" id="middleTruckDetails_AU"><ul id="middleListTruck_AU"><li class="dealername">'+type_local+'</li><li class="dealeryear">'+yrlocal+'</li><li class="dealerland"><span class="contryimg"></span><span class="contytext">'+dealer_state+'</span></li></ul></div><div class="botom" id="bottomTruckDetails_AU"><ul id="lowerListTruck_AU"><li class="dealerrate">'+pricelocal+'</li><li class="dealerstar" onclick="addTofav_AU(\''+truckId_Selctd+'\')"><img id="'+fav_unfavimgid+'" src="themes/images/starrating.png"></li><li class="viewdetail"><a href="#" onclick="getTruckDetails_AU(\''+truckId_Selctd+'\')">VIEW DETAILS</a></li></ul></div></div></div></div>');
                $('#container_ressearcgPage').append('<div class="clearheight"></div>')
                
            }
            else
            {
                $('#container_ressearcgPage').append('<div class="sliderbg" id="topcontainerTruckdetails"><div class="slider-main" id="truckdetailsandPic_Au"><div class="slider-top"><div class="sliderimages"><img src="'+imgurl+'" onclick="getTruckDetails_AU(\''+truckId_Selctd+'\')"></div><div class="sliderlogo"><img width: auto; max-height: 44px !important; src="'+dealerlogo_imgurl+'"></div></div><div class="slidercontner" id="Truckdetails_Container_AU"><div class="top" id="headrTruckDetails_AU"><h3>'+in_t[i]._source.headline+'</h3>'+catgrytoPalce+'</div><div class="mid" id="middleTruckDetails_AU"><ul id="middleListTruck_AU"><li class="dealername">'+type_local+'</li><li class="dealeryear">'+yrlocal+'</li><li class="dealerland"><span class="contryimg"></span><span class="contytext">'+dealer_state+'</span></li></ul></div><div class="botom" id="bottomTruckDetails_AU"><ul id="lowerListTruck_AU"><li class="dealerrate">'+pricelocal+'</li><li class="dealerstar" onclick="addTofav_AU(\''+truckId_Selctd+'\')"><img id="'+fav_unfavimgid+'" src="themes/images/starrating.png"></li><li class="viewdetail"><a href="#" onclick="getTruckDetails_AU(\''+truckId_Selctd+'\')">VIEW DETAILS</a></li></ul></div></div></div></div>');
                $('#container_ressearcgPage').append('<div class="clearheight"></div>')
            }
