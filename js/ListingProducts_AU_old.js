...
//    menuClk=0;
    ...
    var quwerystringSved='https://truckdealersaustralia.com.au/api/search/?'+data_in;
...
//    alert(in_timestamp+'\n'+aj+'\n'+c)
    ...
    if(days<2)
    {
        prnt_val = Math.floor(days)+' day ago';
    }
...
//   alert('value to be printed '+ prnt_val);
    return prnt_val;
