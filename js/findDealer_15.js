...
//    var pCode=false;
//    if(localStorage.getItem('isPostCode')!=null&&localStorage.getItem('isPostCode').length>=4){
//        var pCode= true;
//    }
    $('#fDealerResult').empty();
...
//                    dealerHtml+='<div class="view-rows truckname"><h3>'+res[i]._source.dealership_name+'</h3>'+dist+' Km from '+fixedPost+'</div>';
//                }
//            }
